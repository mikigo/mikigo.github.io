...
privacyconfidencemysterytipsstealth (秘密；秘诀；机密)

classifiedundergroundchamberinsideconfidential (秘密的；机密的)
...
read backecho (重复；复制；背诵)

counterpartiterance (重复；副本)

do overbegin again (重做；重复发生)
...
something that you write down to remind yourself of something
...
billminuteWilliam (笔记；[声]音符；[金融]票据；注解；纸币；便笺；照会；调子)

watchingregistertake care of (注意；记录；注解)
...
chymistchemical process ([化学]化学；化学过程)
...
enhancementgrowthgainraisingadvance (增加，增长；提高)

improvegainacceleratebreedmake (增加，增大；繁殖)

enhanceboostjackmounthot (增加，加大)
...
quicken upto accelerate (超速，加速；加速，迅速前行；兴隆)

velocityprosperityuptempo ([力]速度，速率；迅速，快速；昌盛，繁荣)
...
capacitycompetencetalentqualitypower (能力，能耐；才能)
...
intelligencemindmentality (头脑，智力；脑袋)
...
couplehand in hand (连接；联合；关连)

bandcombine (连接，连结；联合)
...
connect upget in touch with (连接；与…联系)
...
informationawarenesssciencelearningdiscipline (知识，学问；知道，认识；学科)
...
intelligentlycleverly (明智地；聪明地；精明地)
...
WHEN Alexander Graham Bell invented the telephone in 1876, he could never have predicted what it would be able to do in the future.

在1876年亚历山大·格雷厄姆·贝尔发明电话之时，他绝对不会料到电话在未来能做何用途。
...
provincialforeigner (陌生人；外地人；局外人)
...
enhanceboostimprovesimulateaccelerate (穿上；上演；增加；假装；使…上场)
...
a unit for measuring weight, equal to 16  ounce s  or 0.454 kilograms
...
prisondevel (英镑；重击，重击声；兽栏；拘留所)

holdprison (捣烂；敲打；监禁，拘留)
...
strangemundane (世俗的；外行的)

locationsituationsiteslot (位置；短诗；花纹方向)

stakemake a bet (下蛋；打赌)
...
proposaldisposal (展示；安排；花钱；为…划样；提议)
...
restricthold oneself in (系；约束；打结；与…成平局)

knot (打结；不分胜负；被用带（或绳子等）系住)

drawnecktie (领带；平局；鞋带；领结；不分胜负)
...
pull a fast onegive the shaft (欺骗；开玩笑；戏弄)

stupiddonkey (傻瓜；愚人；受骗者)
...
维克拉姆·塞斯花费三年时间写成了他那部1,349页的小说《如意郎君》。
...
mechanicalwooden (无生命的；呆板的；废弃了的)
...
commercethingtradeaffairtruck (商业；生意；[贸易]交易；事情)
...
penalisechastise (惩罚；严厉对待；贪婪地吃喝)

drop acrosscome down on (惩罚)
...
alarmjackmessagealert (警告，提醒；通知)
...
尽管曼谷和清迈都禁止大象上街，但是在城市的郊区，大象还是随处可见的。
...
然而，如果男人们忘了在这个特殊的日子营造浪漫之举，那最好的借口，用顾小白的话说，就是“他们都说与自己心爱的人度过的每一天都是情人节”。
...
不管是一件礼物还是一次体验，尝试新的东西可以让那些美好的日子不至于那么快消散，我第一次当圣诞老人的这一年亦将成为记忆中的永恒。
...
In a restaurant, theatre, or other public place, a restroom is a room with a toilet for customers to use
...
johnconveniencebathroomtoilet (厕所；洗手间；休息室；更衣室)
...
symbolimpressionprintsealflag ([邮]邮票；印记；标志；跺脚)

brandheart (铭记；标出；盖章于…；贴邮票于…；用脚踩踏)

break downgo to sticks and staves (跺脚；捣碎；毁掉)
...
forgivenessabsolution (原谅；[法]赦免；宽恕)

forgivetolerate (原谅；[法]赦免；宽恕)
...
johnconveniencebathroomtoilet (洗手间；盥洗室；厕所)
...
johnconveniencetoilet (浴室；厕所；盥洗室)
...
rapidwhitewater (冲进；匆促；急流；[植]灯心草)

sweep downsurprise attack (使冲；突袭；匆忙地做；飞跃)

thread one's waycrash (冲；奔；闯；赶紧；涌现)
...
有人提议，如果再有球员被出售，球队主教练就辞职。

**同近**

voteadvise (提议，建议；启发；使人想起)
...
armourdawk (邮件；邮政，[邮]邮递；盔甲)

send offpack off (邮寄；寄出)
...
regionareadifficultyzonesection (角落，拐角处；地区，偏僻处；困境，窘境)

stock (囤积；相交成角)

forestallmonopolize (垄断；迫至一隅；使陷入绝境；把…难住)
...
civilelegantgentlemildcourteous (有礼貌的，客气的；文雅的；上流的；优雅的)
...
courteouslydecorously (有礼貌地；客气地；委婉地；殷勤地)
...
一些英语单词对说其他语言的人来说是很难的。

**同近**

lecturerrostrum (演讲者；[电子]扬声器；说话者；说某种语言的人)
...
orientationguidanceaspecttendencyinstruction (方向；指导；趋势；用法说明)
...
rectifyadmonish (改正；告诫)

adjustadapt for (调整；纠正错误)

righttruejust (正确的；恰当的；端正的)
...
The game terminated in a victory for Italian team.
...
usefulbeneficialadvantageousconduciveassistant (有帮助的；有益的)
...
markstwenty (分数；二十；配乐；[木]刻痕)

acquireearnbuyfindvalue (获得；评价；划线，刻划；把…记下)
...
addresslecturetalksound (演讲；讲话；[语]语音；演说)
...
glory inbe pleased (自豪，高兴；以……而骄傲)
...
flagfoundertube (失败，不及格；破产；缺乏；衰退)

disappointlet down (不及格；使失望；忘记；舍弃)
...
inspectioncheckingmonitoring (考试；检查；查问)
...
I can stand Janet now. She and her brother are both at boarding school.

维罗尼卡说，“我现在能受得了珍妮特，她兄妹两都在寄宿学校。”

**同近**

public schoolpensione (寄宿学校)
...
selfrespectpretension (自豪；骄傲；自尊心)
...
ordinaryintegratedsyntheticcomprehensiveaverage (一般的，普通的；综合的；大体的)

strategosaga (一般；将军，上将；常规)
...
presentationadoption (介绍；引进；采用；入门；传入)
...
briefsloppy (偷工减料的；草率的)

GermanBoche (（英）德国兵；德国人)
...
Before lunch he taught the foreigner how to use chopsticks.
...
mirrorvitrum ([玻璃]玻璃；玻璃制品；镜子)

imageto reflect (反映；给某物加玻璃)
...
algodonBaumwolle (棉花；[纺]棉布；棉线)

squareidentifycoincide (一致；理解；和谐；亲近)
...
durabilitytightness (钢铁；钢制品；坚固)

indurate (钢化；使冷酷)

strongtough (钢制的；钢铁业的；坚强的)
...
attractcauseoperateoccasioninduce (生产；引起；创作)

manufactureworkagricultural products (农产品，产品)

turn outbring in (生产，创作)
...
an author who had travelled widely in East Asia
...
I have friends even though I am a man of few words. ＃
...
faceoutsidegarment (表面；表层；外观)

externalfacialshallowsuperficial (表面的，肤浅的)
...
representhangtracefigure ([涂料]油漆；绘画；装饰；描绘)

colorpek ([涂料]油漆；颜料；绘画作品)
...
aliveactualsinceretellingvivid (活泼的；生动的；真实的；生气勃勃的)
...
pressurehigh temperature (高温；压力；热度；热烈)

impassionemotionalize (使激动；把…加热)
...
entertainmentwishhopejoypromise (快乐；希望；娱乐；令人高兴的事)

gladsatisfy (使高兴；使满意)

be pleasedrejoice (高兴；寻欢作乐)
...
...the metal zipper on his jacket.

…他的夹克上的金属拉锁。

**同近**

slide fastenerzip-fastener ([轻]拉链)
...
everydayhouseholdroutine (日常的；每日的)

journal (日报；朝来夜去的女佣)

habituallydiurnally (日常地；每日；天天)
...
statementdirectorybillcontent ([计]列表；清单；[图情]目录)
...
almostmostvirtuallypractically (差不多，几乎；密切地)
...
snuff atsniff at ([生理]嗅，闻；有…气味)

nosesnuff at ([生理]嗅，闻；察觉到；发出…的气味)

nosewindodor (气味，[生理]嗅觉；臭味)
...
occurhappengenerateproceedcelebrate (发生；举行)
...
far and awaywell and truly (无疑地；确实地)
...
keypocket ([五金]锁，锁上；隐藏)

chain upseize up ([五金]锁；锁住；卡住)

spokebrake ([五金]锁；[水利]水闸；刹车)
...
delicatelivelyfragile (酥脆的；易碎的；干净利落的；生气勃勃的)
...
grindingacidraisedevilsharp ([化学]酸的；发酵的；刺耳的；酸臭的；讨厌的)

go badget tired of (发酵；变酸；厌烦)
...
clientappleconsumerfellowegg ([贸易]顾客；家伙)
...
goalsintentionsakeobjectiveuse (目的；用途；意志)

proposethink (决心；企图；打算)
...
chief actorstarring actor (英雄；男主角，男主人公)
...
全美篮球协会(National Basketball Association)，国家篮球协会 （美国职业篮球联赛）
...
tobaccoephemerality ([环境]烟；抽烟；无常的事物)
...
permitpatent (执照，[专利]许可证；特许)

permitcharter ([专利]许可；特许；发许可证给)
...
活动参加者对转基因食品的安全性提出了质疑。

**同近**

insurancesecurityassurance ([安全]安全；保险；安全设备；保险装置；安打)
...
Say It Loudbawl out (叫喊；哭出；大声说)

callwow (叫喊；叫声；口号；呼叫)

blubstare after (哭；叫；喊)
...
domainprovinceterritoryworldkingdomuniverse (领域；牧场；旷野；战场；运动场)

wildferal (扫描场；田赛的；野生的)
...
promotestimulatepreferupgradespirit (举起；提升；鼓舞；空运；抄袭)

evanesceflee (消散；升起；耸立)

elevatorup with (电梯；举起；起重机；搭车)
...
angersadnessyouthswrath (青少年（等于teenager）；愤怒；悲哀)
...
opportunitypossibilityprobabilityfeasibilityopening (机会，际遇；运气，侥幸；可能性)
...
possessrunregulateconductdirect (管理；经营；控制；设法)

cope withhandle with (处理；应付过去)
...
relationscorporationassociationleagueclub (社会；交往；社团；社交界)
...
deviceapparatusinstallationcomponentsparts ([计量]单位，单元；装置；[军]部队；[机]部件)
...
英文文例句：What professional qualifications does he have?
...
institutecome intoparticipate ingo intoget into (进入；开始；参加)

participate intake part ingo through (参加，登场；进去)

importinputting ([计]输入；回车)
...
So who are your real friends and whose real friends are you?
...
pictureideal (粉红色；化身，典范；石竹花；头面人物)

stickstring (扎，刺，戳；使…变粉红色；使…面红耳赤)
...
pigcopperbobbyfinest (警察，警员；[分化]淀帚（橡皮头玻璃搅棒）)
...
Lothariolady-killer ([脊椎]狼；色狼；残忍贪婪之人)

tie intogulp down (大吃；狼吞虎咽地吃)
...
inactiveslumberous (欲睡的；困乏的；不活跃的)
...
moneycontainervesselQIAN (口袋；钱；容器)

lockstomachstandgotough (隐藏；忍受；将…放入衣袋)

miniativebaby-size (小型的，袖珍的；金钱上的)
...
relating to creatures from another world
...
Yes, I can play not only the piano but also the guitar.
...
cyclerevolutionrotationroundrecurrence (循环，周期；圆；圈子；圆形物)

wheelorbitspin (盘旋，旋转；环行)
...
acknowledge receipt ofto hand (收到；接待；接纳)
...
chiefMosescaptainbossconductor (领导者；首领；指挥者)
...
high summerJune solstice (仲夏；盛夏；夏至)
...
vitalityspiritsoulmindspring ([物]能量；精力；[劳经]活力；精神)
...
in order to show how much you admire and respect someone
...
The stadium was named in honor of the club’s first chairman.
...
fatherrootgrandfather (始祖，[生物]祖先；被继承人)
...
successprosperitywinhit (胜利；成功；克服)
...
hourcirclecycleseasonday (周期，期间；时期；月经；课时)
...
You need to understand that Stonehenge is in Crop Circle Country, and that there have been significant Crop Circles in fields right opposite the Henge.

你必须知道巨石阵坐落在麦田圈泛滥的国家，而且那里一直有着具有重大意义的麦田圈，正好就在巨石阵的正对面。
...
interferencecompetitionswordtacticsconflict ([军]战争，斗争；军事，战术；冲突，对抗，竞争)

competecampaignfightbattle (打仗，作战；对抗)
...
英文释义：the director of education
...
co-directorboss-man (主任，[管理]主管；[电影]导演；人事助理)
...
stagetheaterscenario (戏剧，戏剧艺术；剧本；戏剧性事件)
...
abundancelots ofwealthoceansea (丰富，大量；充足)

sufficientnumerouscompetent (足够的，很多的)
...
lots ofwealthoceanseabillion (大量；很多；许多)
...
close downclose up (关闭；停业；幽禁)

closureclosing down (关闭)
...
frightnaupathia (惊骇；惨状；极端厌恶；令人恐怖的事物)
...
feel that something exists or is true, without being told or having proof
...
conceptconsciousnessperceptionfeelmind ([生理]感觉，官能；观念；道理；理智)
...
regretfeelingcompassionmercysympathy (怜悯，同情；遗憾)
...
possesscontainregulatebitbottle (控制；精通；征服)

teacherprofessorartisthostgreat (硕士；主人；大师；教师)

experiencedprimarymajorskilledcentral (主人的；主要的；熟练的)
...
words that show approval of or admiration for someone or something
...
traumacutvulnus (创伤，伤口)

hurt (使受伤)

get hurtget injured (受伤，伤害)
...
This is quite an amazing feat seeing as how it had to rise up after the end of World War II when it found itself almost destroyed.
...
作为巨大波涛的海浪和浪花崩溃在帕劳的海岸，由250多个岛屿组成国家，这些岛屿是第二次世界大战期间日本的据点。
...
hugetremendousenormousmassivemacro (巨大的；四价钛的)
...
segmentact (段（围棋、柔道、空手道等运动员的技艺等级）；浮标)
...
crazypossessedfoolishstupidbugs (疯狂的；发疯的；愚蠢的；着迷的)
...
lose one's coollose temper (变的恼怒，发火；变得着迷)
...
transportationcommercetradecarriage ([交]交通；运输；贸易；[通信]通信量)

exchangetrade in (交易，买卖)
...
registerformulateprogramme (用粉笔写；用白垩粉擦；记录；规划)

cretapastille ([轻]粉笔；[岩]白垩；用粉笔划的记号)
...
perioddaypage ([天]季节；时期)

adaptconditionsuit (使适应；给…调味)
...
way ofmodecategoryvarietynature (方式；习惯；种类；规矩；风俗)
...
darkhollowbarevacant (空的；无意义的；无知的；徒劳的)
...
elementaryfundamentalessentialprimaryfirst ([岩]基本的；基础的)

foundationelementbasebedfactor (基础；要素)
...
adviceproposalinstancerecommendationtrace (建议；示意；微量，细微的迹象)
...
我们曾在卡利（哥伦比亚西部城市）一起度过近两个月，又在布宜诺期艾利斯相遇相聚了两个月。

The executive order invoked the International Emergency Economic Powers Act, which we had earlier used successfully against the Cali drug cartel in Colombia.

该决策令援引了《国际紧急经济权力法》，我们曾成功运用该法令打击哥伦比亚的卡利派毒品垄断组织。
...
fellowshipcompanionship (友谊；友爱；友善)
...
wanaxRex (国王；最有势力者；王棋)

to rulereign over (统治；做国王)
...
greatestmajorelementarycentralmain (主要的；最好的；基本的)

excellentlyfamously (极好地)

youthmorningessenceeliteflower (初期；青年；精华；全盛时期)
...
weakgraydirtywan (苍白的；无力的；暗淡的)

extentboundaryregionspectrumterritoryarea (前哨；栅栏；范围)

overshadowwan (使失色；使变苍白；用栅栏围)

lose countenancewan (失色；变苍白；变得暗淡)
...
Reginalady in waiting (女王，王后；（纸牌中的）皇后；（蜜蜂等的）蜂王)
...
inspectreviewsurvey (检查；调查； 检测；考试)

probecheck for (检查；调查)
...
used after a negative statement to say that the negative statement is also true for someone or some­thing else
...
treasurelots ofoceanmoneyfortunesea ([经]财富；大量；富有)
...
significanceburdenstressstrainconsequence ([物]重量，重力；负担；[计量]砝码；重要性)
...
be in goal/keep goal (= be the goalkeeper)
...
bootback flushing (踢；反冲，朝后座)

backflushingbounce-back (踢；反冲，后座力)
...
soonfirstlotbitpreferably (宁可，宁愿；相当)
...
tensiondigging rope (拉，拉绳；拉力，[交]牵引力；拖)
...
coordinate one's efforts tojoin hands (齐心协力)
...
例句：他们商量后，他会不会同意去看望继母？

**同近**

accordanceprotocolunityidentitykeeping ([法]协议；同意，一致)
...
evergreen treewintergreen ([植]冬青树（等于holm oak）)
...
laborerfactory hand ([劳经]工人；劳动者；职蚁)
...
porepeer at (凝视，盯着看；显眼)

peer atgaze at (凝视，盯着看)
...
人们对这些谋杀事件的反应是震惊和不敢相信。

**同近**

doubtchallengesuspicion (怀疑，不信)
...
beyondwithoutthan (超过；在……上面；在……之上)

hereinabovethereinbefore (在上面；在上文)
...
combustoverfire (燃烧；烧毁，[植保][外科]灼伤；激起…的愤怒)

glowconflagrate (燃烧；烧毁；发热)

brandscaldy ([植保]灼伤，[外科]烧伤；烙印)
...
leaderemployerchiefcaptainlandlord ([劳经]老板；首领；工头)

officercaptainlead (指挥，调遣；当…的领导)
...
pastietalkee-talkee (馅饼；饼图；爱说话的人)
...
在争论过程中，最厉害的事实谬误简直有增无减。

The course should be history,but history, philosophized,is a history of ideas as well as of events.

过程应该就是历史，不过哲学化的历史，就是又有观念又有事件的历史。

**同近**

pathmechanismprocesswayroad (过程；进程；道路；一道菜)

pursuechase after (追赶；跑过)
...
sellfoxmake a fool of (愚弄；欺骗)

confidence trickmischief (骗局；恶作剧)
...
wardroomIrvine (军官，警官；公务员，政府官员；船长)

captainbossleadto command (指挥)
...
basisterminalbaseextreme (底部；末端；臀部；尽头)
...
governmentalcommonable (公众的；政府的；公用的；公立的)

societyambiente (公众；社会；公共场所)
...
evilillblackwicked (丑陋的；邪恶的；令人厌恶的)
...
behalfsuperiorityassetbenefitedge (优势；[经]利益；有利条件)

gainmake a profit (获利)

favor ofbe conducive to (有利于；使处于优势)
...
investedspendexpend (花费；使付出；使花许多钱)

feechargeexpensepricelosing (费用，[贸易]代价，[会计]成本；损失)
...
一条鲨鱼绕着我们的船缓缓转圈，我们都看到它的鳍。

**同近**

fimpterygium ([鱼]鳍；鱼翅；鳍状物)
...
approachwaysystemmediumhow (方法；条理；类函数)
...
flatshallow (低的，浅的；卑贱的；粗俗的；消沉的)

sotto voceshamefacedly (低声地；谦卑地，低下地)
...
domainmanufacturing (产业；[工业]工业；勤勉)
...
legislationlitigationsuitlawsuit ([法]法律；规律；法治；法学；诉讼；司法界)

take legal actiongo to court (起诉；控告)

sue forbring charge against (控告；对…起诉)
...
portalmain entrance ([建]大门；出入口；门道)
...
possesscontainregulatebitmanage (控制；把…装入瓶中)
...
他们陪伴玛丽和肯恩真的是出于诚挚的感情吗？ 亦或是这些悲惨的人能令他们感觉（或是看起来）更好?
...
criterionnormslevelprototypeCanon ([标准]标准；水准；旗；度量衡标准)

normalpar ([标准]标准的；合规格的；公认为优秀的)
...
克里斯·凯利(吉他手)和本尼·海斯(键盘手和主唱)

**同近**

keysetkey panelklavier ([计]键盘)
...
dualtwo-fold (双重的；两倍的)

redouble (加倍，加倍努力；快步走)

duplicate (使加倍)

twifoldtwofold (双重地；两倍地；弓身地)
...
criterionstandardnormsprototype (水平；标准；水平面)

horizontalflateven (水平的；平坦的；同高的)

aim fortake aim at (瞄准；拉平；变得平坦)
...
sirdonMisterMonsieur (先生；绅士；有身分的人)
...
the time when you complete a university degree course or your education at an American  high school
...
dryeagerhungryanxiousdesired (口渴的，口干的；渴望的，热望的)
...
lackingvoid of (没有的，一点没有的)

nothingnoway (决不，一点也不)
...
forthin advancepreviouslytoalong (领先；向前；预先)

forwardantrorse (领先的；向前的)
...
警方认为该地区其他三宗谋杀案也是此人所为。

**同近**

answer forlie behind (对……负责；是……的原因)
...
not joined to or touching something else
...
splitdivorce (使分离；使分开；使分居)

come betweento break (分开；隔开；分居)

aloneindependentdividedisolatedsole (单独的；分开的)

partitionfall-away (分开；抽印本)
...
alafaction ([天]翼；[昆]翅膀；飞翔；派别)

liftair transportation (使飞；飞过；空运；增加…速度；装以翼)
