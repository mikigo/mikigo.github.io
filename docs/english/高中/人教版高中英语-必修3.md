...
festivalcommemoration (庆典，庆祝会；庆祝；颂扬)
...
My aunt’s a deeply religious person.

我姑母是个非常虔诚的信徒。

**同近**

goodsacred (宗教的；虔诚的；严谨的；修道的)
...
That year, in memory of a famous politician, the citizen set up a memorial near the Medeiterranean.
...
faithteachingtrustdoctrine (相信，信赖；信仰；教义)
...
Oct 12, a legal holiday in most states of the US: the date of Columbus' landing in the West Indies in 1492
...
Some of the largest paredes occur on  Columbus Day (the second Monday in October), Veterans Day (November 11), independence Day (July 4), and Labor Day (the first Monday in September).

一些大型游行在哥伦布纪念日（10月的第二个星期一），退伍军人节（11月11日），独立日（7月4日），及劳动节（9月的第一个星期一）举行。
...
enhancementincreaseprofitmarginharvest (增加；利润；收获)

acquireearnenhancebuyscore (获得；增加；赚到)

improveadvantageaccelerategrow in (增加；获利)
...
farmingextractive industry ([农]农业；农艺，[农学]农学)
...
DionysiaFasching (狂欢节，嘉年华会；饮宴狂欢)
...
weargarmentapparel (（总称）[服装]服装；帆装)

coveringdressing (覆盖（clothe的ing形式）；给…穿衣)
...
hymenvirginal membrane ([木][园艺]樱桃；樱桃树；如樱桃的鲜红色；处女膜，处女)
...
succeedcome into flower ([植]开花；兴旺；发展成)

bloominflorescence ([植]花；开花期；兴旺期；花开的状态)
...
have a good timehave a great time (玩得高兴，玩得开心)
...
modestyletype (时尚；[服装]时装；样式；时髦人物)

make use ofemployinfluenceexerciseshift (使用；改变；做成…的形状)
...
an open area for cars to park in
...
parking areaparking garageparking groundstopping placecar-park ([交]停车场)
...
occurhappengeneratedetectproceed (出现；发生；开大；发现；卷起；使仰卧)
...
“He’s saying one thing and he’s doing the other,” McCain declared, urging Obama to “keep your word to the American people.”

麦凯恩说："他说的是一回事，做的是另一回事。" 他敦促奥巴马："遵守你对美国人民的承诺"。
...
distinctvisibleprominentmarkedevident (明显的；显著的；平淡无奇的)
...
chattererflibbertigibbet (鹊，喜鹊；饶舌的人；有收集零碎东西癖好的人)

miscellaneouspied (鹊的；有收集癖的；斑驳的，混杂的)
...
watershed tears (哭泣；流泪；哀悼；滴落；渗出液体)

shed tearspipe one's eye (哭泣；流泪；悲叹；流出或渗出液体)

tearseyedrop (哭泣；眼泪；滴下)
...
set outset loose (出发；引起；动身；使爆炸；抵销；分开)
...
put in mind ofwarn (提醒；使记起；使回想起)
...
dischargepardon for (原谅；免除（债务、义务等）)
...
Your diet is the type and variety of food that you regularly eat
...
strengthforcemightpowerbeef (肌肉；力量)

enhancecementbuild up (加强；使劲搬动；使劲挤出)
...
phylacticshielded (防护的；关切保护的；保护贸易的)
...
agarictoadstool (蘑菇，伞菌；蘑菇形物体；暴发户)
...
fushiacherry red (桃子；[园艺]桃树；桃红色；受人喜欢的人（或物）)

informrat (告密)

tell onblow the whistle (告发)
...
regularityequilibriums (平衡；[会计]余额；匀称)

equilibrizeclose an account (使平衡；结算；使相称)

suitbe commensurate to (保持平衡；相称；抵销)
...
small pieces of meat and vegetables cooked on a stick

**同近**

kebobkabob (（印）烤肉串；烤腌羊肉串（等于kabob）)
...
torrefybake (烤，焙；烘，烘烤；暴露于某种热力下以得温暖)

broiltoast (烤；烘)

bakingbroiled (烘烤的；烤过的)

bulgogibar-b-q (烤肉；烘烤)
...
a brown sweet  soft drink  , or a bottle, can, or glass of this drink
...
sweetsacchariferous (含糖的；甜的；[岩]糖状的；甜言蜜语的)
...
loose weightshed weight (减肥；体重减轻)
...
crudefreshunripe ([食品]生的；未加工的；阴冷的；刺痛的；擦掉皮的；无经验的；（在艺术等方面）不成熟的)
...
但在你没有准备好去南部边境生活的时候：要考虑两种产品的成分，醋和盐，这一组合的联合使用，似乎可以引起一个清洗金钱的反作用。
...
Repeating himself he said "If you tell a lie big enough and keep repeating it, people will eventually come to believe it."

他不断地告诉自己：“如果你撒了一个足够大的谎并且不断地重复它，人们总有一天会相信它。”

It is not justthat the brain uses more energy to tell a lie, Langleben says, but that theresponse pattern is visibly different, at least during the highly structuredquestionnaire.

对此，Langleben解释道，不仅仅撒谎时大脑会调动更多能量，而且至少在高度结构化的问卷里，答案的模式显著不同。
...
absorbdrink in (消化；吸收；融会贯通)

abstractbriefsummaryresume (文摘；摘要)
...
Without the vitamin, scurvy would bring on rashes and gum disease, not to mention very bad breath.

而坏血病就是由于缺乏维他命而导致的，会引起皮疹，牙周病的症状，口臭就更不在话下。

**同近**

poorbasedirtymeanblue (卑鄙的，下流的)
...
We are not disagreeing with the fact that their instruments detected protein.

我们不同意他们的设备探测到蛋白质这一事实。
...
detectscout around (侦察；发现；暗中监视)

scout aroundkeek (侦察；[军]当间谍)

illegalespionage ([军]间谍；密探)
...
"An officer cannot use our product to spy on his wife, for example," Mr. Valleri said.

瓦利瑞解释说：例如，一个政府官员不能用我们的产品暗中监视他的妻子。
...
restrictionqualificationbarrier (限制；限度；界线)
...
This will let in his legions of demons and before long you will find yourself in darkness and despair.

恶魔的军队随之而入，不久以后，你就会发现自己陷入了黑暗和绝望中。
...
不论如何，人们都不应该抱着一种预防青光眼的希望来增肥，基肖尔说，“千万不要在体重增加的同时心想这么做可能会保护你自己”。
...
collaborationsynergism ([劳经]合作，[经]协作；协力)
...
country of birthborn city (出生地)

## 157. Florida

**中释**

佛罗里达镇（位于密苏里州）佛罗里达州（美国州名）
...
introducepresentpreferraisestay (提出；教育；养育；呕出；（船等）停下)
...
He had relocated his family for the position from Ohio to Missouri, where he bought a home.

为了这个职位，他从俄亥俄州举家搬迁到密苏里州，并且买了一幢房子。
...
childhood daysyoung age (童年，少年时代；男孩们)
...
‘Under the weather’ is an idiom which means ‘ill’. under the weather

under the weather 是习语,意思是“病了”

**同近**

idiomdiction (成语；习语；措词)
...
see throughlook through (看穿；彻底了解；测量…的深度)
...
lose oneselfhang about (徘徊；漫步；迷路；离题)

rangelouse around (游荡，漫游)
...
to allowmake a promise (许可；允许)

licenselethavegrant (许可；允许)

licensepatent (许可证，执照)
...
according to what a lot of people say it has spent
...
interpretationexplanationconstructionsakereason ([会计]帐户；解释；帐目，帐单；理由)

result into interpret (解释；导致；报帐)

countfindguessfeelrate (认为；把…视为)
...
bear responsibility forbe obligated to (对…负有责任；对…做出解释；说明……的原因)
...
exploretry to find (寻求；寻找；探索；搜索)

explorecast about for (寻找；探索；搜索)
...
toleranceendurance (耐性，耐心；忍耐，容忍)
...
coverinvolucrum (信封，封皮；包膜；[天]包层；包迹)
...
footgross total ([会计]总计，合计；相当于；[数]共计；产生…结果)

sumquantity ofgrosstotal (数量；总额，[数]总数)
...
adventurerun a riskstick one's neck out (冒险)
...
pipeshriek (尖叫；呼啸；发出尖锐刺耳的声音；令人触目惊心)
...
institutionorganizationmethodapproachscheme (制度，体制；系统；方法)
...
the single large explosion that some scientists suggest created the universe
...
lots ofwealthoceanseabody (十亿；大量)
...
this earthly roundterra ([天]地球；地球仪；球体)
...
in the nick of timeat the right moment (及时；适时)
...
differentdiversevaryinganotherdissimilar (不同的，不相似的)
...
elementarybasicessentialorganicprimary (基本的，根本的)

basic principleultimaterationale (基本原理；基本原则)
...
existencebeingentityis ([植]存在；出席；参加；风度；仪态)
...
responsebehaviorinductionreception ([生理][化学][医]反应，感应；反动，复古；[力]反作用)
...
breedimproveaccelerategain (乘；繁殖；增加)

diversiformvariant (多层的；多样的)
...
Batrachiaamphibious plane ([脊椎]两栖动物；[车辆]水陆两用飞机；具有双重性格的人)
...
poormeanbasedirty (爬虫类的；卑鄙的)

insectratfink ([脊椎]爬行动物；卑鄙的人)
...
Occasionally, hens lay eggs with imperfect shells or without shells altogether.

有时候，母鸡产蛋要么壳不完美要么干脆没有壳。
...
而他们最令人叹为观止的特点是：科摩多巨蜥可以单性繁殖——即雌性科摩多巨蜥可以再未受精的情况下产蛋。
...
thereforehenceaccordinglyconsequentlyso (因此；从而；这样；如此)

sosothat (因此)

frankincenseolibanumbalm of Gileadbalsam of Gileadmastix (乳香)
...
life-formliving things (（一个地区全部的）[生物]生物；生物学)
...
一位生物学家发展了一套公式，用来计算到底有多少遗传物质可以被保留下来的时候，利他的行为才是值得的。
...
weightseriousness ([力]重力，地心引力；严重性；庄严)
...
pacificmoderatesoftmildtemperate (温和的；文雅的)

softenmilden (使温和，使驯服)
...
然而，一位资深巴基斯坦地质学家说，这个趋势也可能是因为这个地区与西方工业革命同时开始的大规模的灌溉计划造成的。
...
物理学最广为人知的一条定律——对任何一个动作而言，存在一个相同大小的反作用——由艾萨克·牛顿发现。
...
在他帮助开创的核时代来临之际，阿尔伯特·爱因斯坦说：“现在，一切都改变了……”。 他还警告说：“我们正在向一场无法比拟的灾难滑落。
...
(路透社)-在周一的声明中，剑桥大学称，史蒂芬·霍金教授，世界上最顶尖的物理学家之一，因患重病而在剑桥住院。
...
"The position of the pool, which floats 12 metres above the ground, at its extreme edge, gives the swimmer the feeling of floating – weightlessly between heaven and earth, " said the architects.

建筑师说：“游泳池的位置，浮在地面上12米，给游泳者带来浮动的感觉——感受天与地之间的失重，”建筑师说。
...
pieceblocklots ofwealthoceansea (块，团；群众，民众；大量，众多)

concentratedintensivewholesale (群众的，民众的；大规模的，集中的)

concentratecollectcrowd (聚集起来，聚集)
...
trickmischief (考查；恶作剧；课堂测验)

dig attest for (挖苦；张望；对…进行测验)
...
“它的大小只是家猫的一半，它只可能猎食力所能及的任何动物，”领导这项探险的卡尔加里大学古生物学家尼克·朗瑞奇说到。
...
在渥太华的一场新闻发布会上，她说：“在考察的后期，我们一晚上就会被冰流冲出去三海里……这也是一个主要因素。”

The Ottawa Charter of 1986 established the core principles of Health Promotion which seek to identify and positively affect the root causes, or determinants, of health.
...
英文例句: ...the former prime minister of Pakistan, Miss Benazir Bhutto.
...
managersadjustmentruler (主管人员；统治者，管理者；[机][自]调节器；地方长官)
...
mainlandearthland ([地理]大陆，洲，陆地)

self-regulatingrestrained (自制的，克制的)
...
landscapeviewpictureprospectoutlook (风景；景色；舞台布景)
...
upgraderisingupclimbing (向上的；上升的)
...
investcaseenclose (围绕；包围)

entironmentgirdle (围绕物)
...
Mother, meanwhile, is too busy showing the grandchildren the latest pics of her kayaking classes in the Rocky Mountains to bother about her once traditional place as resident housekeeper.

母亲，一样忙于展示她儿孙最近在皮艇课上做的生产信息系统。 在落基山脉烦恼这这个曾经作为家庭主妇呆过的地方。

Old geologic processes, such as the opening of the Atlantic and the uplift of the Rocky Mountains, may have squeezed the Midwest.

过去的地质进程，如大西洋的开放和落基山脉隆起，可能对中西部产生了挤压。
...
make one's pitchput down roots (定居；安定下来；专心于)
...
Joe: Well, I think you have a gift for it. There was a perfect blend of poetry and meanness.

乔： 额，我想你有这方面的天赋，你真的是将诗意与卑贱完美的组合在一起了。
...
hilfrontier (边境；[地理]边界；国界)

go on forcome close to (接近；与…接壤；在…上镶边)
...
Lake is the main port of Duluth United States and Canada Thunder Bay, and so on.

主要湖港有美国的德卢斯和加拿大的桑德贝等。
...
蓄水完成后，将形成一个长度达440英里（660公里），宽3600英尺（1100米）的狭长型大湖，其长度比苏必利尔湖长处60英里（97公里），宽度是长江自然河道的两倍。
...
themesubjecttitlesmotive (主题（等于theme）；题目；一般规则；总论)
...
mixhybridcompound ([热][化学][化工]混合；混合物；[药]混合剂)
...
shrubfrutex ([林]灌木；矮树丛)

peter (以灌木装饰；使…精疲力竭)

cluster (丛生；浓密地生长)

robustgrossroughcountry (如灌木般长得低矮的；粗野的)
...
Jack Frostindifference (霜；[气象]冰冻，严寒；冷淡)
...
richsufficientplenary (富有的；充分的；丰裕的)
...
从比格，你可以看到她的头在远处欧楂果树的篱笆墙上露出来，篱笆墙把我们的土地跟她子女家的隔离开来。
...
concession standstall (货摊；公用电话亭)
...
intowninner-city (市中心的)

urban centerinner city (市中心区)
...
treasureperla ([水产]珍珠；珍珠色；杰出者；珍品)
...
morningorigin ([天]黎明；开端)

come outbreak of day (破晓；出现；被领悟)
...
adjacentsurrounding (附近的，邻近的)

aroundclose by (在附近)

in the shadow ofin the vicinity of (在…附近)
...
conventionusageheritagetaleprescription (惯例，传统；传说)
...
happygladfonddelighted (高兴的；喜欢的；乐意做某事)
...
affectingheart-warming (感人的；令人钦佩的；给人以深刻印象的)
