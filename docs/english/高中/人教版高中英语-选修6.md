...
a style of painting used especially in France in the 19th century which uses colour instead of details of form to produce effects of light or feeling
...
And he painted her portrait--one of the great paintings of all time, right up there with the "Mona Lisa"--as a final, loving tribute.

他还为她画了肖像，作为最后的爱的信物。 这张肖像一直被认为是一幅伟大的杰作，和蒙娜·丽莎齐名。
...
预期的效果是在曼哈顿区的地图上放置书签，公寓列表的每处房产对应一个书签。
...
Now many people might think that I was only joking when in one of my articles lately I said that reading the English nursery rhyme about Taffy the Welshman could help to educate the soul of a man.

余新近写有一文，曰，读威尔士人泰菲所作之英语童谣，有益于教化人之心灵。 览此文者，多以为，此乃玩笑而已。
...
an American bird that copies the songs of other birds
...
the man who in the past owned most of the land around a country village in England
...
a part of a tree that grows out from the trunk (等于main stem ) and that has leaves, fruit, or smaller branches growing from it
...
The lorry hadshed its load(= the load had fallen off ).
...
人体免疫缺损病毒（艾滋病病毒）；（Human Immunodeficiency Virus）的缩写
...
非典型性肺炎；（Severe Acute Respiratory Syndromes）的缩写
...
a thin rubber bag that a man wears over his  penis (等于sex organ )  during sex, to prevent a woman having a baby or to protect against disease
...
if someone, especially a man, is homosexual, they are sexually attracted to people of the same sex
...
If this is true, it means that the UK will not cut its greenhouse gases by 80% by 2050, as the government promised. It means it will cut them by 40%.

如果这是真的，这意味着英国将不会象政府承诺的那样，到2050年削减其80%的温室气体排放量，这意味着英国将只削减40%。
...
It was Charles Keeling who measured the carbon dioxide content in the atmosphere between 1957 and 1997.

是查尔斯。奎林把1957-1997年期间大气层中二氧化碳的含量作了精确的统计。
...
For the query in this article, the basic statistics of the referenced tables, columns and indexes were collected, such as the table cardinality, column cardinality, and so on.
...
relating to or involving the nucleus (等于 central part ) of an atom, or the energy produced when the nucleus of an atom is either split or joined with the nucleus of another atom
...
The protesters were demonstrating against the opening of a new dump on the slopes of Mount Vesuvius.

反对者们抗议在维苏威火山的半坡上启用一处新的垃圾场。
...
The cloud is a pyrocumulonimbus cloud, a powerful thunderstorm that forms over large fires.

这团云雾是由下方凶猛火势积累形成的强大的雷暴。
...
You have only three minutes to glance through this article.
