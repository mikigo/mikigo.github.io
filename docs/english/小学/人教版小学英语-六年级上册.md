...
in the processon the move (步行；在进行中)
...
speed reductiondecrease speed (减速，放慢速度；使……慢下来)
...
Plan a weekend to go out with friends to barbecue countryside, see a film, play electronic games, play footaball or barly take a walk together.
...
By the way, would you like to see a film with me tomorrow?A new film is on at the Capital Cinema.

顺便问一下，明天你愿不愿意和我一起去看电影? 首都电影院在上演一部新片。

**同近**

see a moviewatch a film (看电影)
...
colorfulfunny (喜剧的；滑稽的；有趣的)

funnystripcartoon (连环漫画；喜剧演员；滑稽人物)
...
A postcard is a thin card, often with a picture on one side, which you can write on and mail to people without using an envelope
...
几年前，我收到一个在怀俄明州杰克逊霍尔的朋友寄给我的明信片，上面写道：“我正在尽情的滑雪！”

My Christmas present is a post card. There is a lovely panda in it.

我的圣诞节礼物是一张明信片，上面有一只可爱的熊猫。
...
The Mid-Autumn Festival is a Chinese festival that is held to celebrate the end of the summer harvest, when the crops have been gathered. It is also called the . 
...
后来，人们在八月十五那天集合起来推翻了元朝统治。 从那以后，月饼成为中秋节不可或缺的元素。
...
concentratepartying (聚会；聚集；收集；积累)
...
A mooncake is a type of cake that is eaten during the Chinese . It is filled with a thick paste, and often has a salted egg inside it. 
...
a plant that grows up a wall, frame etc and has small sweet-smelling white or yellow flowers
...
警官说你们巴基斯坦现在也不安全，但是我仍然希望回到祖国去生活，我爱我的祖国。
...
父亲在那里的赫尔大学担任教育学院图书馆馆长。 1955年，母亲在法国修道院学校任英语教师，尽管她信奉新教，不久还是被升为代理校长。
...
If you notice a bad smell or think you may have an infection, see a doctor or gynecologist right away.

如果你发现了身上有难闻的气味，或者你认为自己得了传染病，马上去看医生、或者妇科医生。
...
momentevidencesignsecondwind (呼吸，气息；一口气，（呼吸的）一次；瞬间，瞬息；微风；迹象；无声音，气音)
...
实际上，我们应该抽出时间到户外走走，观赏自然美景，深深呼吸新鲜空气，享受泉水和草木的宁静。
...
go aftertrack down (追逐；追捕；试图赢得；雕镂)

pursuego after (追逐；追赶；奔跑)

pursuithunting (追逐；追赶；追击)
...
We disinfested the kitchen of mice.
...
if someone who has been ill is doing well, they are becoming healthy again
