...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表一 术语</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表二 压力测试场景</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图一 1021文管Accessbility标签</center>
...
![x操作](/test/x操作.png)
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图二  Xdotool和Xwininfo流程</center>
...
![速度](/test/速度.png)
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图三  Python 脚本与 shell 脚本运行速度对比</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图四  xdotool 不稳定</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表三 二种方案优缺点总结</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表四 BUG 列表</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图五  输入事件响应流程</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图六 xlib 窗口说明</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图七  app-wininfo-m 模块结构</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表五 app-wininfo-m参数文件说明</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图八 demo运行结果</center>
...
| X86      | 正常运行 |
| ARM64    | 正常运行 |
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表六 兼容性运行结果</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>表七 稳定测试项</center>
...
<center style={{ color: '#C0C0C0', textDecoration: 'underline' }}>图九 demo运行速度</center>
