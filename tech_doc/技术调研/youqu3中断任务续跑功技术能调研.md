...
![image1](/youqu3中断任务续跑功技术能调研_assets/image1.png)

<div style={{ textAlign: 'center' }}>图1 执行流程</div>
...
**pytest\_addoption：** 定义新增的三个自定义参数
...
**pytest\_report\_teststatus:** 实时记录用例执行结果
...
**pytest\_sessionfinish：** 测试完成基于日志，输出汇总数据：total、passed、failed、skipped
