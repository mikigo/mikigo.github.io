...
* 模型 FP16 权重约 70GB，Q4\_K\_XL 量化后 21GB
...
| 量化等级 | 大小 | 质量 | 适用场景 |
|---------|------|------|---------|
| Q4\_K\_M | ~19 GB | 中等 | 显存极度紧张 |
| **Q4\_K\_XL** | **~21 GB** | **较好** | **8~16GB 显存，推荐** |
| Q5\_K\_M | ~23 GB | 好 | 16GB+ 显存 |
| Q6\_K | ~25 GB | 很好 | 24GB+ 显存 |
| Q8\_0 | ~30 GB | 接近原始 | 32GB+ 显存 |

对 8GB 显存的卡，Q4\_K\_XL 基本是最优选择：体积和 Q4\_K\_M 相近，但质量更接近 Q5\_K\_M。
...
| 模型格式 | GGUF (UD-Q4\_K\_XL) | 21GB，在质量和体积间取平衡点 |
| 编译配置 | CMake + CUDA sm\_89 | Ada Lovelace 架构专门优化 |
